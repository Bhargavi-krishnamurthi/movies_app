...
ActiveRecord::Schema.define(version: 2022_12_09_061013) do
  ...
  create_table "genre_categorizations", force: :cascade do |t|
    ...
    t.index ["movie_id"], name: "index_genre_categorizations_on_movie_id"
  end
  ...
  add_foreign_key "genre_categorizations", "genres"
  add_foreign_key "genre_categorizations", "movies"
